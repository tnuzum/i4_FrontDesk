...
public class DailybusinessReport extends base{
	...
	@Test(enabled = true, description = "Daily business Report_Employee contact List")
	public void DailyBusinessReport_CheckInByMemberName() throws Exception {
		...
		jse.executeScript("arguments[0].click();",report.getSelect_EmployeeContactList());
		...
		Assert.assertTrue(driver.findElement(By.xpath("//*[@id='Text2']/p[1]/span/span")).isDisplayed());
		System.out.println("Report name and date:  "+driver.findElement(By.xpath("//*[@id='Text2']/p[1]/span/span")).getText());
		Thread.sleep(2000);
		...
		jse.executeScript("arguments[0].click();", driver.findElement(By.xpath("//button[@type='button']")));
		System.out.println("*-----------------------------------------------*");
